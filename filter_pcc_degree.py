#
# Filter genes by PCC and degree
#
# Reads the degree file per network and the edge pcc values file (generated by
# dump_degree.py and pcc_values.py). Only prints genes which have less than a
# given PCC value and has more than a given number of edges in either network.
#
...
# discards pcc values which are higher than the cutoff
...
# prints the merged set to the screen
